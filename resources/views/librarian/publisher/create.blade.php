    ...
    <div class="container">
        <div class="row">
            ...
            <div class="offset-md-7 col-md-2">
              <a class="add-new" href="{{ route('librarian.publishers') }}">All Publishers</a>
            </div>
        </div>
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form class="yourform" action="{{ route('librarian.publisher.store') }}" method="post" autocomplete="off">
                    @csrf
